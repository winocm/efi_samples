...
#else
extern PyObject **p_PySys_TraceFunc, **p_PySys_ProfileFunc;
extern int *p_PySys_CheckInterval;
#define _PySys_TraceFunc (*p_PySys_TraceFunc)
#define _PySys_ProfileFunc (*p_PySys_ProfileFunc)
#define _PySys_CheckInterval (*p_PySys_CheckInterval)
#endif
