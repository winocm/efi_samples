...
#else
extern PyTypeObject *pPyType_Type;
...
#else
extern long *p_Py_RefTotal;
#define _Py_RefTotal (*p_Py_RefTotal)
#endif
...
#else
extern PyObject *p_Py_NoneStruct;
#define Py_None (p_Py_NoneStruct)
#endif
