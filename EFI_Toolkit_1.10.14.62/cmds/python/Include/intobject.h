...
#else
extern PyTypeObject *pPyInt_Type;
...
#else
extern PyIntObject *p_Py_ZeroStruct, *p_Py_TrueStruct;
#define Py_False ((PyObject *) p_Py_ZeroStruct)
#define Py_True  ((PyObject *) p_Py_TrueStruct)
#endif
