...
static PyObject *instance_compare1 Py_PROTO((PyObject *inst, PyObject *other));
static int instance_compare Py_PROTO((PyObject *inst, PyObject *other));
#endif
