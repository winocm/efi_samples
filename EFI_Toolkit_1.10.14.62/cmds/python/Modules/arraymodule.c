...
static PyObject *c_getitem Py_PROTO((arrayobject *, int));
static int c_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *b_getitem Py_PROTO((arrayobject *, int));
static int b_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *BB_getitem Py_PROTO((arrayobject *, int));
static int BB_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *h_getitem Py_PROTO((arrayobject *, int));
static int h_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *HH_getitem Py_PROTO((arrayobject *, int));
static int HH_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *i_getitem Py_PROTO((arrayobject *, int));
static int i_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *II_getitem Py_PROTO((arrayobject *, int));
static int II_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *l_getitem Py_PROTO((arrayobject *, int));
static int l_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *LL_getitem Py_PROTO((arrayobject *, int));
static int LL_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *f_getitem Py_PROTO((arrayobject *, int));
static int f_setitem Py_PROTO((arrayobject *, int, PyObject *));
static PyObject *d_getitem Py_PROTO((arrayobject *, int));
static int d_setitem Py_PROTO((arrayobject *, int, PyObject *));
#endif
	...
	PyObject *args;
{
	return Py_BuildValue("ll",
			     (long)((UINTN)(self->ob_item)), (long)(self->ob_size));
}
	...
	PyObject *args;
{
	...
	if (n > 0) {
		...
		self->ob_item = item;
		self->ob_size += n;
		nread = (int)fread(item + (self->ob_size - n) * itemsize,
			      itemsize, n, fp);
		if (nread < n) {
...
static PyObject *a_array Py_PROTO((PyObject *, PyObject *));
...
initarray()
{
    ...
    Arraytype.ob_type = pPyType_Type;
#endif
