...
static PyObject *regex_compile Py_PROTO((PyObject *, PyObject *));
static PyObject *regex_symcomp Py_PROTO((PyObject *, PyObject *));
static PyObject *regex_match Py_PROTO((PyObject *, PyObject *));
static PyObject *regex_search Py_PROTO((PyObject *, PyObject *));
static PyObject *regex_set_syntax Py_PROTO((PyObject *, PyObject *));
static PyObject *regex_get_syntax Py_PROTO((PyObject *, PyObject *));
#endif
	...
	PyObject *args;
{
	...
	if (!PyArg_ParseTuple(args, "S|S", &pat, &tran))
		return NULL;
	return newregexobject(pat, tran, pat, (PyObject*)NULL);
}
...
#if defined(EFI32) || defined(EFI64)
    if (_PyString_Resize(&npattern, (int)(n - v)) == 0)
#else
