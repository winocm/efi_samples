...
supporting documentation, and that the name of Lance Ellinghouse or Intel Corporation
not be used in advertising or publicity pertaining to distribution 
of the software without specific, written prior permission.

LANCE ELLINGHOUSE AND INTEL CORPORATION DISCLAIMS ALL WARRANTIES WITH REGARD TO
THIS SOFTWARE, INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY AND
FITNESS, IN NO EVENT SHALL LANCE ELLINGHOUSE OR INTEL CORPORATION BE LIABLE FOR ANY SPECIAL, 
...
#ifdef EFI_LOADABLE_MODULE
struct _inittab Efi_InitTab = { "rotor", initrotor };
#endif
