 ...
 *
 * $Id: regexpr.c,v 1.1.1.1 2003/11/19 01:43:59 kyu3 Exp $ */
...
#if defined(EFI32) || defined(EFI64)
                    old_regs->start[a] = (int)(GET_REG_START(state, a) - textstart);
					old_regs->end[a] = (int)(GET_REG_END(state, a) - textstart);
#else
