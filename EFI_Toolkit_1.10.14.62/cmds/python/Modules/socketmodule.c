...
#if defined(EFI32) || defined(EFI64)
static PyObject *PySocket_gethostname (PyObject *self, PyObject *args);
static PyObject *PySocket_gethostbyname (PyObject *self, PyObject *args);
static PyObject *PySocket_gethostbyname_ex (PyObject *self, PyObject *args);
static PyObject *PySocket_gethostbyaddr (PyObject *self, PyObject *args);
static PyObject *PySocket_getservbyname (PyObject *self, PyObject *args);
static PyObject *PySocket_getprotobyname (PyObject *self, PyObject *args);
static PyObject *PySocket_socket (PyObject *self, PyObject *args);
static PyObject *PySocket_fromfd (PyObject *self, PyObject *args);
static PyObject *PySocket_ntohs (PyObject *self, PyObject *args);
static PyObject *PySocket_ntohl (PyObject *self, PyObject *args);
static PyObject *PySocket_htons (PyObject *self, PyObject *args);
static PyObject *PySocket_htonl (PyObject *self, PyObject *args);
...
BUILD_FUNC_DEF_2(PySocketSock_recv,PySocketSockObject *,s, PyObject *,args)
{
	...
	if (buf == NULL)
		return NULL;
	Py_BEGIN_ALLOW_THREADS
	n = (int)recv(s->sock_fd, PyString_AsString(buf), len, flags);
	Py_END_ALLOW_THREADS
	if (n < 0) {
		Py_DECREF(buf);
		return PySocket_Err();
...
BUILD_FUNC_DEF_2(PySocketSock_recvfrom,PySocketSockObject *,s, PyObject *,args)
{
	...
	if (buf == NULL)
		return NULL;
	Py_BEGIN_ALLOW_THREADS
	n = (int)recvfrom(s->sock_fd, PyString_AsString(buf), len, flags,
#ifndef MS_WINDOWS
#if defined(PYOS_OS2)
...
BUILD_FUNC_DEF_2(PySocketSock_send,PySocketSockObject *,s, PyObject *,args)
{
	...
	if (!PyArg_ParseTuple(args, "s#|i", &buf, &len, &flags))
		return NULL;
	Py_BEGIN_ALLOW_THREADS
	n = (int)send(s->sock_fd, buf, len, flags);
	Py_END_ALLOW_THREADS
	if (n < 0)
		return PySocket_Err();
...
BUILD_FUNC_DEF_2(PySocketSock_sendto,PySocketSockObject *,s, PyObject *,args)
{
	...
	if (!getsockaddrarg(s, addro, &addr, &addrlen))
		return NULL;
	Py_BEGIN_ALLOW_THREADS
	n = (int)sendto(s->sock_fd, buf, len, flags, addr, addrlen);
	Py_END_ALLOW_THREADS
	if (n < 0)
		return PySocket_Err();
	return PyInt_FromLong((long)n);
...
struct _inittab Efi_InitTab = { "socket", initsocket };
#endif
