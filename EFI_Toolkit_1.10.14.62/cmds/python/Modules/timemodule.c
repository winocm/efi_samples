...
#ifdef HAVE_MKTIME
static PyObject *time_mktime Py_PROTO((PyObject *, PyObject *));
#endif
static PyObject *time_ctime Py_PROTO((PyObject *, PyObject *));
static PyObject *time_asctime Py_PROTO((PyObject *, PyObject *));
#ifdef HAVE_STRPTIME
static PyObject *time_strptime Py_PROTO((PyObject *, PyObject *));
#endif
#ifdef HAVE_STRFTIME
static PyObject *time_strftime Py_PROTO((PyObject *, PyObject *));
#endif
static PyObject *time_localtime Py_PROTO((PyObject *, PyObject *));
static PyObject *time_gmtime Py_PROTO((PyObject *, PyObject *));
static PyObject *time_sleep Py_PROTO((PyObject *, PyObject *));
static PyObject *time_clock Py_PROTO((PyObject *, PyObject *));
static PyObject *time_time Py_PROTO((PyObject *, PyObject *));
#endif
	...
	PyObject *args;
{
	...
	for (i = 1024; ; i += i) {
		...
		buflen = (int)strftime(outbuf, i, fmt, &buf);
